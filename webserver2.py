...
class WSGIServer(object):
    ...
    def server_forever(self):
        ...
        while True:
            ...
            #loop over to wait for anthor client connection.
    ...
    def handle_one_request(self):
        ...
        #It time to call our application callable and
        #get back a result that will become HTTP reponse body
        result = self.application(env, self.start_response)

        #Construct a response and send it back to a client
    ...
    def get_environ(self):
        ...
        #to emphasize the required variables and values.
        #
        #Required WSGI variables
        env['wsgi.version'] = (1, 0)
        env['wsgi.url_scheme'] = 'http'
        env['wsgi.input'] = StringIO.StringIO(self.request_data)
        env['errors'] = sys.stderr
    ...
    def start_reponse(self, status, response_headers, exc_info=None):
        ...
        server_headers = [
            ...
            #a 'write' callable. We simplicity's sake we'll ignore the detail
            #for now.
